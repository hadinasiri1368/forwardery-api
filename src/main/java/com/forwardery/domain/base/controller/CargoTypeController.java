...
public class CargoTypeController extends BaseController<CargoType, Long, CargoTypeDto, CargoTypeRepository> {

    public CargoTypeController(BaseService<CargoType, Long, CargoTypeRepository> service, CargoTypeMapper mapper) {
