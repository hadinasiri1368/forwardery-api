...
public abstract class BaseController<E, ID extends Serializable, D, R extends BaseRepository<E, ID>> {
    protected final BaseService<E, ID, R> service;
    protected final BaseMapper<E, D> mapper;

    public BaseController(BaseService<E, ID, R> service, BaseMapper<E, D> mapper) {
